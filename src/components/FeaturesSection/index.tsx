  ...
  <div style={{ position: 'relative', width: '100%', paddingBottom: '100%' }}>
    <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ position:'absolute', width:260, height:260, borderRadius:'50%',
        ...
        top:'5%', left:'5%', filter:'blur(40px)' }} className="pulse-glow" />
      <div style={{ position:'absolute', width:200, height:200, borderRadius:'50%',
        background:'radial-gradient(circle, rgba(99,102,241,.3) 0%, transparent 70%)',
        bottom:'10%', right:'5%', filter:'blur(35px)', animationDelay:'1.5s' }} className="pulse-glow" />
      ...
      <div className="glass-card float" style={{
        ...
        <div style={{
          ...
          <div style={{ position:'relative', zIndex:2 }}>
            <div style={{ fontFamily:"'Be Vietnam Pro', sans-serif", fontWeight:900,
      ...
      <div className="glass-mini badge-pop" style={{
        ...
        <div style={{ display:'flex', alignItems:'center', gap:6 }}>
          <div style={{ width:20, height:20, borderRadius:8,
      ...
      {/* Crown */}
      <div style={{ position:'absolute', top:'5%', left:'30%', fontSize:22,
        filter:'drop-shadow(0 0 8px rgba(251,191,36,.6))',
        animation:'floatSlow 5s ease-in-out infinite 0.3s' }}>👑</div>
      ...
      <div className="glass-mini float-delayed" style={{
        ...
        <div style={{ background:'#3b82f6', fontSize:7, textAlign:'center',
          color:'#fff', fontWeight:700, padding:'2px 0', letterSpacing:.5 }}>CAL</div>
        <div style={{ background:'rgba(255,255,255,.9)', textAlign:'center',
          fontSize:16, fontWeight:900, color:'#1e3a8a', padding:'2px 0' }}>14</div>
      </div>
  ...
  <div style={{ position: 'relative', width: '100%', paddingBottom: '100%' }}>
    <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ position:'absolute', width:280, height:280, borderRadius:'50%',
        ...
        top:'0%', right:'0%', filter:'blur(45px)' }} className="pulse-glow" />
      <div style={{ position:'absolute', width:200, height:200, borderRadius:'50%',
        background:'radial-gradient(circle, rgba(6,182,212,.25) 0%, transparent 70%)',
        bottom:'5%', left:'5%', filter:'blur(35px)', animationDelay:'2s' }} className="pulse-glow" />
      ...
      <div className="glass-card float" style={{
        ...
        <div style={{ display:'flex', alignItems:'center', gap:7, marginBottom:8 }}>
          <div style={{ width:26, height:26, borderRadius:10,
      ...
      <div style={{ position:'absolute', bottom:'20%', left:'5%', zIndex:15,
        animation:'floatDelayed 6s ease-in-out infinite 1s' }}>
        <div className="glass-mini" style={{ borderRadius:14, padding:'7px',
  ...
  return (
    <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:80, alignItems:'center' }}>
      ...
      <div style={{ ...col1Style, display:'flex', flexDirection:'column', gap:28 }}>
        ...
        <p style={{ color:'rgba(148,163,184,1)', fontSize:16, lineHeight:1.75, margin:0,
          ...
          {points.map((point, i) => (
            <li key={i} style={{ display:'flex', alignItems:'center', gap:12,
              ...
              <span style={{ width:20, height:20, borderRadius:6,
                ...
                display:'flex', alignItems:'center', justifyContent:'center',
                fontSize:11, color:accentHex, flexShrink:0 }}>✓</span>
              {point}
            </li>
          ))}
        </ul>
      ...
      <div style={{ ...col2Style, position:'relative' }}>
        <div style={{ position:'absolute', inset:0, background:blurHex,
    ...
    <section style={{ background:'#0e0e18', padding:'120px 0' }}>
      <div style={{ maxWidth:1200, margin:'0 auto', padding:'0 40px' }}>
        ...
        <div style={{ textAlign:'center', marginBottom:96 }} className="section-appear">
          ...
          <p style={{ color:'rgba(148,163,184,1)', fontSize:17, maxWidth:520,
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:140 }}>
          <FeatureBlock
            ...
            description="Hệ thống AI của chúng tôi tự động tạo ra nội dung quảng bá, tiêu đề sự kiện hấp dẫn và chiến dịch email marketing cá nhân hóa cho từng đối tượng khách hàng."
            points={[
