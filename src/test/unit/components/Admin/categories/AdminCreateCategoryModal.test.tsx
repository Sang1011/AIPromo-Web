...
import AdminCreateCategoryModal from '../../../../../components/Admin/categories/AdminCreateCategoryModal'
...
describe('AdminCreateCategoryModal', () => {
  ...
  describe('Render', () => {
    it('should render without crashing', async () => {
      await act(async () => {
        render(<AdminCreateCategoryModal onClose={mockOnClose} />)
      })
      expect(screen.getByText('Tạo Category mới')).toBeInTheDocument()
    })
