...
describe('fmtMoneyVND', () => {
  describe('Basic formatting', () => {
    ...
    it('should format thousands correctly', () => {
      expect(fmtMoneyVND(1000)).toBe('1 nghìn')
      expect(fmtMoneyVND(5000)).toBe('5 nghìn')
      expect(fmtMoneyVND(999999)).toBe('1000 nghìn')
    })

    it('should format millions correctly', () => {
      expect(fmtMoneyVND(1000000)).toBe('1 triệu')
      expect(fmtMoneyVND(5500000)).toBe('5.5 triệu')
      expect(fmtMoneyVND(999999999)).toBe('1000 triệu')
    })

    it('should format billions correctly', () => {
      expect(fmtMoneyVND(1000000000)).toBe('1 tỷ')
      expect(fmtMoneyVND(1500000000)).toBe('1.5 tỷ')
      expect(fmtMoneyVND(2000000000)).toBe('2 tỷ')
    })
  })
  ...
  describe('Edge cases', () => {
    ...
    it('should handle decimal numbers', () => {
      ...
      expect(fmtMoneyVND(1040000)).toBe('1 triệu')
    })

    it('should handle very large numbers', () => {
      expect(fmtMoneyVND(1000000000000)).toBe('1000 tỷ')
    })
